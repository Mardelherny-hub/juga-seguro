                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mt-4">
                                ...
                                @if($transaction->type === 'account_creation')
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        ✓ Crear usuario <strong>{{ $transaction->player->name }}</strong> en el panel externo del casino<br>
                                ...
                                @elseif($transaction->type === 'account_unlock')
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        ✓ Desbloquear usuario <strong>{{ $transaction->player->name }}</strong> en el panel externo del casino<br>
                                        ✓ Una vez desbloqueado, aprobar esta solicitud
                                    </p>
                                @elseif($transaction->type === 'password_reset')
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        ✓ Cambiar contraseña de <strong>{{ $transaction->player->name }}</strong> a: <strong class="text-red-600">bet123</strong><br>
